...
public class OpenApiConfig {
    ...
    return new OpenAPI()
        ...
        .servers(new ArrayList<>(List.of(
            ...
            new Server().url("https://gestion-compte-om-1.onrender.com").description("Production (Render)"),
            new Server().url("https://gestion-compte-om-2.onrender.com").description("Production (Render)")
        )));
    }
